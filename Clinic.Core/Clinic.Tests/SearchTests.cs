...
namespace Clinic.Tests
{
    ...
    public class SearchTests
    {
        ...
        public void SearchByTimeInterval()
        {
            ...
            var visit1 = CreateClinicalVisit(office, new DateTime(2010, 1, 1, 12, 0, 0), new DateTime(2010, 1, 1, 13, 0, 0));
            var visit2 = CreateClinicalVisit(office, new DateTime(2010, 1, 1, 13, 0, 0), new DateTime(2010, 1, 1, 14, 0, 0));
            var visit3 = CreateClinicalVisit(office, new DateTime(2010, 1, 1, 17, 0, 0), new DateTime(2010, 1, 1, 18, 0, 0));
